...
// Icon Components (Bahar rakhe hain taaki bar-bar render na ho)
const UsersIcon = () => (
...
export default function AdminPage() {
  ...
  // Fast Data Loading using Promise.all
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      loadData()
      setSyncTime(new Date().toLocaleTimeString())
    }, 15000) // 15s pe update karo, 5s server pe load badhta hai
  ...
  return (
    // ✅ Mobile Fix: max-w-[100vw] overflow-x-hidden
